        ...
        return (
            <div style={{marginBottom:20}}>
                ...
                <Input.Group style={{marginLeft:10,marginTop:8}}>
                    <Input addonBefore = "部门" autoFocus placeholder="请输入名称" style={{marginRight:20,width:200}}/>
                    ...
                    <Button ref={this.btnRef} type="primary" onClick = {this.handelShowDrawer}>
                        <PlusOutlined /> 新增
                    </Button>
                </Input.Group>
                <div style ={{height:15}}/>
                <TableComponent handelMark={this.handelMark}/>
                <DrawerComponent
